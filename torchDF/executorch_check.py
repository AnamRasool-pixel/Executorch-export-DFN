...
def main(args):
    ...
    #example_input = torch.randn(1, 480)  # Adjust size based on your model's input
    #scripted_model = torch.jit.script(torch_df)

    sample_rate = 48000
    example_input = (torch.randn(1, 480),sample_rate)
    pre_autograd_aten_dialect = capture_pre_autograd_graph(torch_df, example_input)
